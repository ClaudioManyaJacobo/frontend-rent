...
import { CategoriasVehiculosService } from '../../../categorias-vehiculos/services/categorias-vehiculos.service';
import { SucursalesService } from '../../../sucursales/services/sucursales.service';
import { NotificationService } from '../../../../core/services/notification.service';
import { AuthService } from '../../../../core/auth/auth.service';
import { resolveRoleName } from '../../../../core/auth/auth-role.util';
...
export class VehiculoFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.sucursalesService.findAll(1, 200).subscribe({
    ...
    if (id && id !== 'new') {
      ...
      this.vehiculoId = id;
      this.vehiculosService.findOne(id).subscribe({
        next: (v) => {
  ...
  submit(): void {
    ...
    const request$ =
      this.isEdit() && this.vehiculoId
        ? this.vehiculosService.update(this.vehiculoId, payload)
